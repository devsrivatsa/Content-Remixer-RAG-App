...
class EmbeddedChunk(VectorBaseDocument, ABC):
    ...
    def to_context(cls, chunks: list["EmbeddedChunk"]) -> str:
        ...
        for i, chunk in enumerate(chunks):
            context += f"""Chunk {i+1}: Type: {chunk.__class__.__name__} Platform: {chunk.platform} Author: {chunk.author_full_name} Content: {chunk.content}\n"""
